...
insert into Cliente (idCliente, nome, telefone, email, endereco) values
     ...
     (2, 'Mario Vicente', '(11) 99527-3721', 'mario.v@email.com.br', 'Avenida Ipiranga, 1246, apto. 201, SÃ£o Paulo - SP'),
     ...
     (7, 'Paula Roberta Vitorino', '(65) 98953-7828', 'paula.v@email.com.br', 'Rua dos AÃ§udes, 1029, CuiabÃ¡ - MT'),
...
insert into Editora (idEditora, nome, telefone, email, endereco) values
     (1, 'Companhia da Leitura', '(11) 3854-2946', 'companhiadaleitura@email.com.br', 'Avenida Brasil, 458, SÃ£o Paulo - SP'),
     (2, 'Arco da Velha', '(21) 3916-5859', 'arcodavelha@email.com.br', 'Rua das Estradas de Pedras, 568, sala 12, Rio de Janeiro - RJ'),
     (3, 'Mais InformÃ¡tica', '(62) 3425-2064', 'maisinformatica@email.com.br', 'Avenida Linda de GoiÃ¡s, 627, GoiÃ¢nia - GO'),
     (4, 'Sexta dos Estudos', '(41) 3789-3438', 'sextadosestudos@email.com.br', 'Rua Sete de Setembro, 1568, sala 29, Curitiba - PR'),
     (5, 'CiÃªncia da InformaÃ§Ã£o', '(11) 3678-1284', 'cienciadainformacao@email.com.br', 'Rua Vinte e Cinco de Maio, 678, sala 3, SÃ£o Paulo - SP');
...
insert into Livro (idLivro, idEditora, titulo, autor, ano, ISBN, preco) values
     ...
     (2, 1, 'Controlando as EmoÃ§Ãµes', 'LetÃ­cia de Munhoz Neta', 2021, '123-0-2054-4896-7', 35.90),
     (3, 1, 'Brasil Brasileiro', 'Mariana Luiza de Andrade', 2020, '578-0-4586-2946-2', 49.90),
     (4, 2, 'Se Eu Voltasse no Passado', 'DionÃ­sio Siqueira', 2021, '248-0-1029-3045-4', 42.90),
     (5, 2, 'Penso, Logo Existo', 'Ana Martinha Ramos', 2019, '745-0-3486-5149-6', 55.90),
     (6, 2, 'Lugares para Viajar Sozinho', 'MaurÃ­cio de Andrade', 2022, '647-0-6128-9745-1', 69.90),
     (7, 3, 'Aprendendo Python em 24 Horas', 'Joaquim Luiz Machado', 2019, '358-0-7458-6485-5', 99.90),
     (8, 3, 'Banco de Dados: Aprenda de Forma Simples e FÃ¡cil', 'Pedro AntÃ´nio Zamba', 2018, '942-0-8125-6479-8', 119.90),
     (9, 3, 'Java para Que Te Quero', 'LuÃ­za Soraia do Nascimento', 2019, '834-0-4726-1495-9', 99.90),
     (10, 4, 'MatemÃ¡tica Descomplicada', 'Ana LuÃ­za de Souza', 2017, '356-0-2746-9175-2', 79.90),
     (11, 4, 'PortuguÃªs para Estrangeiros', 'VinÃ­cius Matheus Furlan', 2018, '674-0-4861-3186-3', 89.90),
     (12, 4, 'EstatÃ­stica Ã© para Todos', 'Sofia Castela', 2020, '527-0-2943-4715-5', 59.90),
     (13, 5, 'Big Data: Conhecimentos Essenciais', 'Ana Daniela Vivan', 2023, '453-0-2495-8371-8', 121.90),
     (14, 5, 'CiÃªncia de Dados: O Futuro', 'JoÃ£o Paulo Macedo', 2024, '924-0-7165-6249-9', 149.90),
     (15, 5, 'InteligÃªncia Artificial Aplicada a Dados', 'Marli Terezinha Girotto', 2023, '694-0-1973-4826-7', 169.90);
...
from Editora a, Livro b
where a.idEditora = b.idEditora
order by nome desc;
